...
set_first_bg_tile:
	; Write to nametable $2000 index 1
	lda #$20
	sta $2006   ; Write the high byte of $2000 to PPUADDR
	lda #$00
	sta $2006   ; Write the low byte of $2000 to PPUADDR
	; Write '1' to the PPU data register, intending to write to $2000
    lda #$01
    sta $2007

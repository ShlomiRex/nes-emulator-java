...
public class PPU {
    ...
    public byte bg_shifter_pattern_lo, bg_shifter_pattern_hi;

    public byte bg_shifter_attrib_lo, bg_shifter_attrib_hi;
...
//            throw new IllegalArgumentException("Unexpected CHR ROM / pattern table size");
    ...
    private void load_BG_shifters() {
        // TODO: This causes all the pixels to be wrong
